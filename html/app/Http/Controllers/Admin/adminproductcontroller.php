...
class AdminProductController extends Controller
{
	...
	public function submitProduct(Request $request)
	{
		...
		else
		{
			...
			$product->submitProduct($category, $productCode, $productName, $brandName, $price, $sale, $productDescription, $sizeChart, $sizeSale, $colourImage, $genStock, $genImage);
	...
	public function submitEditProduct(Request $request)
	{
		...
		$product->editProduct($productId, $reGenerate, $genSize, $category, $productCode, $productName, $brandName, $price, $sale, $productDescription, $sizeChart, $sizeSale, $colourImage, $genStock, $genImage);
