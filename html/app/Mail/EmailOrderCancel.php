...
class EmailOrderCancel extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
		...
		$body = '<div style="margin-bottom:15px;">Dear Customer,</div>
					<div style="margin-bottom:15px;">We do apologize to inform you that the item is not available. Please do not do any payment for this transaction.</div>
					<div style="margin-bottom:15px;">Your transaction is cancelled.</div>
		...
		return $this->view('email/defaultorder')->subject("Demor Boutique : Your order has been cancelled")->with("data",$payment);
    }
}
