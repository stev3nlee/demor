...
class EmailConfirmExchangeAdmin extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
		...
		$body = '<div style="padding: 0 50px; margin-bottom: 15px;">
					...
					<div style="margin-bottom: 15px;">
						...
						<div style="display:inline-block; width: 190px; font : 300 14px/18px \'Lucida Grande\', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242; line-height: 25px;">'. $this->data->orderpayment->orderno .'</div>
					</div>
					<div style="margin-bottom: 15px;">
						...
						<div style="display:inline-block; width: 190px; font : 300 14px/18px \'Lucida Grande\', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242; line-height: 25px;">'. $this->data->orderpayment->accountno .'</div>
					</div>
					<div style="margin-bottom: 15px;">
						...
						<div style="display:inline-block; width: 190px; font : 300 14px/18px \'Lucida Grande\', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242; line-height: 25px;">'. $this->data->orderpayment->accountname .'</div>
					</div>
					<div style="margin-bottom: 15px;">
					...
					<div style="margin-bottom: 15px;">
						...
						<div style="display:inline-block; width: 190px; font : 300 14px/18px \'Lucida Grande\', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242; line-height: 25px;">IDR '.str_replace(",",".",number_format($this->data->orderpayment->totalamount)).'</div>
					</div>
				</div>';
