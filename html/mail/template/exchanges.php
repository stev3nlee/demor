<div style="width: 500px; background: white; border: 1px solid #acacac; margin: 0 auto;">
    ...
    <div style="font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-weight: bold; font-size: 20px; color: #424242;text-align: center; line-height: 25px;">Your message has been received</div>
    <div style="margin: 30px auto;text-align: center;">
        <img src="http://beta.demorboutique.com/assets/images/icons/email-contact.svg"/>
    </div>
	<div style=" padding: 0 50px 30px; font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 14px; color: #424242;text-align: justify; line-height: 25px;">
		<div style="margin-bottom: 15px;">Dear Customer,</div>
		<div style="margin-bottom: 15px;">We acknowledge your request for exchanging your product with us.</div>
		<div style="margin-bottom: 15px;">Please wait up to 1 x 24 hours to receive a reply.</div>
		<div>To make sure our reply doesn't get into your spam box, please add <span style="color: #6d3779;">cs@demorboutique.com</span> to your spam filter.</div>
    </div>
