<div style="width: 500px; background: white; border: 1px solid #acacac; margin: 0 auto;">
	...
	<div style="padding: 0 50px; margin-bottom: 15px;">
		<div style="margin-bottom: 15px;">
			...
			<div style="display:inline-block; width: 190px; font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242; line-height: 25px;"><?php echo $data['fullName']; ?></div>
		</div>
		<div style="margin-bottom: 15px;">
			...
			<div style="display:inline-block; width: 190px; font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242; line-height: 25px;"><?php echo $data['invoiceNumber']; ?></div>
		</div>
		<div style="margin-bottom: 15px;">
			...
			<div style="display:inline-block; width: 190px; font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242; line-height: 25px;"><?php echo $data['productName']; ?></div>
		</div>
	</div>
	...
	<div style=" padding: 0 50px; margin-bottom:15px; font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242;text-align: justify; line-height: 25px;"><?php echo $data['detailProduct']; ?></div>
	<div style="padding: 0 50px; margin-bottom: 5px;">
	...
	<div style=" padding: 0 50px 30px; font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 12px; color: #424242;text-align: justify; line-height: 25px;"><?php echo $data['reason']; ?></div>
