<div style="width: 500px; background: white; border: 1px solid #acacac; margin: 0 auto;">
    ...
    <div style="font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-weight: bold; font-size: 20px; color: #424242;text-align: center; line-height: 25px;">Account Activation</div>
    <div style="margin: 30px auto;text-align: center;">
        <img src="http://beta.demorboutique.com/assets/images/icons/email-register.svg"/>
    </div>
    <div style=" padding: 0 50px; font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; font-size: 14px; color: #424242;text-align: justify; line-height: 25px;">
		<div>Thank you for registering an account at Demor Boutique.</div>
        <div>To activate your account, please click the following button: </div>
    </div>
    <a href="http://beta.demorboutique.com/register/activate/<?php echo $data['userid'].'/'.$data['ischange'] ?>" target="_blank" style="font : 300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif; background: #6d3779; color: white; border-radius: 5px; text-decoration: none; display: block; width: 205px; font-size: 14px; margin: 30px auto; padding: 12px 5px; font-weight: bold; text-align: center;">ACTIVATE MY ACCOUNT</a>
