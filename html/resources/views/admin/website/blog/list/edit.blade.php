				...
				<div class="clearfix row">
					<div class="wdth50">
						<div class="form-group">
							...
							<div><img style="width: 250px; margin-bottom: 10px;" src="{{ url($list->images[0]->filepath) }}"/></div>
					...
					<div class="wdth50">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="urlImageStatic" value="{{ $list->images[0]->urlpath }}"/>
						</div>
					</div>
				</div>
				<div class="clearfix row">
