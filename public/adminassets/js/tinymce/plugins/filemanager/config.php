...
$upload_dir = '/admin/assets/uploads/tinymce/new/'; // path from base_url to upload base dir
$current_path = '../../../../uploads/tinymce/new/'; // relative path from filemanager folder to upload files folder
