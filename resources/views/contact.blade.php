	...
	<div id="content">
		<div class="container">
			<div class="map pos-rel clearfix">
				<a href="https://www.google.com/maps/place/De'mor+Boutique/@-6.2262733,106.8078015,14z/data=!4m8!1m2!2m1!1sdemor+boutique!3m4!1s0x2e69f3c68c9d0c17:0xcdabfcf1c4e6ec18!8m2!3d-6.2265472!4d106.8254415" target="_blank">
			...
			<div class="row">
				<div class="col-sm-6 resp30">
					...
					<div class="contact20">
						...
						<div class="inline-contact">
							<div class="h30">
								<div class="tbl">
									<div class="cell">
										<div class="t-contact"><a href="mailto:{{ $contact->email }}">{{ $contact->email }}</a></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="contact20">
						<div class="inline-contact mr20">
							<img src="{{ url('/assets/images/icons/contact05.svg') }}" class="img-responsive"/>
						</div>
						<div class="inline-contact">
							<div class="h30">
								<div class="tbl">
									<div class="cell">
										<div class="hidden-xs">
											<div class="t-contact"><a href="https://wa.me/628567998221" target="_blank">{{ $contact->phonenumber }}</a></div>
										</div>
					...
					<div class="contact20">
						...
						<div class="inline-contact">
							<div class="h30">
								<div class="tbl">
									<div class="cell">
										<div class="t-contact"><a href="tel:{{ $contact->mobilenumber }}" target="_blank">{{ $contact->mobilenumber }}</a></div>
									</div>
								</div>
							</div>
						</div>
